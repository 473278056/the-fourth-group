...
public class StudentLog {
     ...
     * 开启查询的日志记录
     */
    @Pointcut("execution(* com.suixingpay.mapper.StudentMapper.query*(..))")
    public void queryAS() {}
     ...
     * 开启更新日志的记录
     */
    @Pointcut("execution(* com.suixingpay.mapper.StudentMapper.update*(..))")
    public void updateS() {}
     ...
     * 开启删除日志的记录
     */
    @Pointcut("execution(* com.suixingpay.mapper.StudentMapper.del*(..))")
    public void delS() {}
